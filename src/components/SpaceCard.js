...
export default function SpacesCard ({title,tags,pic1,pic2,pic3,listenCount,hostPic,hostName,desc,color,hostColor}){
  return (
    <View style={styles.container}>
      ...
      <View style={styles.liveHeadCont}>
        ...
        <Image
          ...
          source={{uri:"https://media.tenor.com/3_AoCT4PqOkAAAAj/musically-beats.gif"}}/>
